...
public class SwordssmpModPotions {
	...
	public static void load() {
		PV_PPOTION = register("pv_ppotion", new Potion("pv_ppotion", new MobEffectInstance(MobEffects.SPEED, 6000, 1, false, true), new MobEffectInstance(MobEffects.STRENGTH, 6000, 1, false, true), new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 6000, 0, false, true)));
