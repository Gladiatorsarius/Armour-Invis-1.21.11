		...
		if (entity instanceof Player player) {
			...
			for (int i = 0; i < size; i++) {
				...
				if (custom != null) {
					...
					String[] knownKeys = new String[] { "ChorusSlayerCooldownUntil", "DescendingDarkCooldownUntil", "DescendingDarkCooldownOwner", "GhostBladeCooldownUntil", "EarthWaveCooldownUntil", "GodsViewCooldownUntil", "PhantomBladeCooldownUntil", "WindBladeCooldownUntil", "WardenBlasterCooldownUntil", "TNTSwordCooldownUntil", "TNTSword2CooldownUntil", "TNTSword2CooldownOwner", "ThunderCooldownUntil" };
